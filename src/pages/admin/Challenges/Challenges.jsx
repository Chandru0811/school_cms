          ...
          <div className="actions-column">
            {storedScreens?.data[7]?.can_edit === 1 && (
              <button
                ...
                onClick={(e) => {
                  e.stopPropagation();
                  navigate(`/challenges/edit/${row.original.id}`);
                }}
              >
      ...
      {loading ? (
          ...
          <>
            <ThemeProvider theme={theme}>
              <MaterialReactTable
                ...
                enableFullScreenToggle={true}
                  ...
                  columnVisibility: {
                    id: !(
                      storedScreens?.data?.[7]?.can_edit === 0 &&
                      storedScreens?.data?.[7]?.can_delete === 0
                    ),
                    working_hrs: false,
                    citizenship: false,
                    nationality: false,
            ...
            {deleteModalOpen && selectedId && (
              <DeleteChange
                path={`challenge/delete/${selectedId}`}
                onDeleteSuccess={() => {
                  getData();
