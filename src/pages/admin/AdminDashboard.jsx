          ...
          <div className="card">
            <div className="row">
              ...
              <div className="col-md-7 col-12 py-3">
                ...
                <p className="heading-color fw-bold">{data?.total_employees}</p>
              </div>
            </div>
          </div>
        </div>
          ...
          <div className="card">
            <div className="row">
              ...
              <div className="col-md-7 col-12 py-3">
                ...
                <p className="dash-font heading-color fw-bold">{data?.total_parents}</p>
              </div>
            </div>
          </div>
        </div>
              ...
              <div className="col-md-6 col-12">
                <div className="row">
                  ...
                  <div className="col-md-9">
                    ...
                    <p className="dash-font fw-semibold fs-5">${data?.total_subscribed_students}</p>
                  </div>
                </div>
              </div>
              <div className="col-md-6 col-12">
                <div className="row">
                  ...
                  <div className="col-md-9">
                    ...
                    <p className="dash-font fw-semibold fs-5">${data?.total_revenue}</p>
                  </div>
                </div>
              </div>
            </div>
                    ...
                    challengeResults.map((challenge, index) => (
                      <div key={index} className="p-2 rounded row">
                        <div className="dash-font d-flex align-items-center justify-content-start">
                          ...
                          <span className="dash-font fw-normal">{challenge.title}</span>
                        </div>
                      </div>
                    ))
                  ) : (
