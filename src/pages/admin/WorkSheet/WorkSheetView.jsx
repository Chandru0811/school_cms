...
function WorkSheetView() {
  ...
  return (
    ...
    //               </div>
    //               <div className="col-6">
    //                 <p className="view-value">Medium</p>
    //               </div>
    //             </div>
    //           </div>
    //           <div className="col-12 my-2">
    ...
    //               </div>
    //               <div className="col-6">
    //                 <p className="view-value">Mr,Newt</p>
    //               </div>
    //             </div>
    //           </div>
    //         </div>
    ...
    //                 <img src={icon} alt="" className=" img-fluid ms-2 py-5" />
    //               </div>
    //               <div className="col-md-8 col-12 py-3">
    //                 <p className="dash-font">TOTAL</p>
    ...
    //               </div>
    //               <div className="col-md-8 col-12 py-3">
    //                 <p className="dash-font">TARGET</p>
    //                 <p className="dash-font heading-color fw-bold">
    //                   20 Questions
    //                 </p>
    //               </div>
    ...
    //             <div className="row">
    //               <div className="col-md-4 col-12 ">
    //                 <img src={icon1} alt="" className=" img-fluid ms-2 py-5" />
    //               </div>
    //               <div className="col-md-8 col-12 py-3">
    //                 <p className="dash-font">REWARD</p>
    //                 <p className="dash-font heading-color fw-bold">
    //                  + 5 Points
    //                 </p>
    //               </div>
