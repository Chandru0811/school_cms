...
function QuestionEdit() {
  ...
  //         parsedOptions = Object.entries(parsedOptions).map(([key, value]) => ({
  //           id: key,
  //           value: value,
  //         }));
  //       }
  ...
  //       selected: parsedAnswer.multichoice === (option.value || option), // Mark selected option
  //     }));
  ...
  const getData = async () => {
    try {
      ...
      // Extract the correct multi-choice answer
      ...
      formik.setValues({
        ...
        answer: [
          {
            fillable: parsedAnswer.fillable || "",
            multichoice: correctMultiChoiceAnswer, // Correctly store multi-choice answer
            short_answer: parsedAnswer.short_answer || "",
            closed: parsedAnswer.closed || "",
          },
        ],
        ...
        <div className="d-flex justify-content-between align-items-center flex-wrap p-2 my-lg-2">
          <div className="d-flex align-items-center">
            ...
            <span className="mx-3 table-heading">
              Update Question -&nbsp;
              <span className="table-subheading">Update a Question</span>
            </span>
          </div>
          <div className="my-2 d-flex align-items-center justify-content-between gap-5">
            ...
            >
              ...
              <FiSave className="trash-icon" /> &nbsp;&nbsp; Save Question
            </button>
          </div>
        </div>
