...
function QuestionEdit() {
  const validationSchema = yup.object().shape({
    ...
    question_type: yup.array().min(1, "*Select at least one question type"),
  });
  ...
  const handleCheckboxChange = (event) => {
    ...
    formik.setFieldValue(
      "question_type",
      checked
        ? [...formik.values.question_type, value]
        : formik.values.question_type.filter((option) => option !== value)
    );
  };
        ...
        <div className="d-flex justify-content-between align-items-center card_header p-2">
          <div className="d-flex align-items-center">
            ...
            <span className="me-2 text-muted">
              &nbsp;
              <span className="database_name">Edit Question & Answer</span>
            </span>
          </div>
        ...
        <div className="card p-3">
          <div className="row gx-3 p-3">
            ...
            <div className="col-md-6 col-12 mb-3">
              ...
              {[
                ...
                <div className="form-check form-check-inline" key={id}>
                  <input
                    ...
                    checked={formik.values.question_type.includes(id)}
                  />
              ...
              {formik.errors.question_type && formik.touched.question_type && (
                <div className="text-danger">{formik.errors.question_type}</div>
              )}
            </div>
            <div className="col-md-6 col-12 mb-3">
              {/* Conditional Fields Based on Selected Checkboxes */}
              {formik.values.question_type.includes("filled") && (
                <div className="mt-2">
              ...
              {formik.values.question_type.includes("closed") && (
                <div className="mt-2">
              ...
              {formik.values.question_type.includes("multiCheckbox") && (
                <>
                  <div className="mt-2">
              ...
              {formik.values.question_type.includes("shortCheckbox") && (
                <div className="mt-2">
              ...
              {formik.values.question_type.includes("uploadCheckbox") && (
                <div className="mt-2">
